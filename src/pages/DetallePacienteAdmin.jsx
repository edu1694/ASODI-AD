      ...
      <div className="flex-grow max-w-4xl mx-auto mt-10 p-8 bg-white shadow-lg rounded-lg">
        {mensaje ? (
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold text-green-600 mb-6 border-b pb-4">Detalles del Paciente (Admin)</h1>
            ...
            {/* Botón para modificar la planilla del paciente */}
            <div className="flex justify-center mt-8">
              <button
                onClick={() => navigate(`/editarpacienteadmin/${paciente.id_planilla}`)}
                className="px-6 py-3 rounded-full font-semibold shadow-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700"
              >
                Modificar Planilla
              </button>
            </div>
...
export default DetallePacienteAdmin;
